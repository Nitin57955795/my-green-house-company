...
var power_gen = 0;
var absorbed1= 0; var absorbed2= 0;
...
function draw() 
{
  ...
  if(power_gen>=8 && temp>=30) { fan.changeAnimation('run'); temp-=1; panel2_voltage-=1 }
  if(power_gen>=4 && temp>=30 ) { fan2.changeAnimation('run'); temp-= 0.5; panel1_voltage-=1 }
